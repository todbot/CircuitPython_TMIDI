...
# This setup is to use TX,RX pins on a Feather or QTPy. You must wire up the
# needed resistors and MIDI jack yourself, or use the MIDI Feather wing

import tmidi

uart = busio.UART(rx=board.RX, tx=board.TX, baudrate=31250, timeout=0.001)
midi_uart = tmidi.MIDI(midi_out=uart, midi_in=uart)
